export const metadata = {
  title: "Контакти",
  description: "Контакти и адрес на ателието на Dana Vitan Boutique в Русе.",
...
export default function ContactsPage() {
  return (
    <main className="relative flex-1 overflow-hidden px-6 pb-20 pt-20 sm:pt-24">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(139,26,47,0.28),transparent_38%),linear-gradient(180deg,rgba(255,255,255,0.03),transparent_36%)]" />
        ...
        <aside className="grid gap-6">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
            ...
            <ul className="mt-5 space-y-4 text-sm leading-6 text-white/75">
              ...
              <li>Подход, който съчетава модерна естетика и усещане за ръчна изработка.</li>
            </ul>
          </div>

          <div className="rounded-[2rem] border border-accent/40 overflow-hidden flex flex-col">
            <p className="text-xs uppercase tracking-widest text-accent px-6 pt-5 pb-3">НАМЕРЕТЕ НИ</p>
